...
<html lang="en">
    ...
    <body class="nav-fixed">
                    ...
                    <div class="drawer-footer border-top">
                        <div class="d-flex align-items-center">
                            ...
                            <div class="ms-3">
                                ...
                                <div class="small fw-500" id="namaUser"></div>
                            </div>
                        </div>
                    </div>
                </nav>
            ...
            <div id="layoutDrawer_content">
                ...
                <main>
                    <div class="container-xl px-5">
                        ...
                        <h2 class="mb-4 mt-5">Tambah Data Absen</h2>
                        ...
                        <form>
                                ...
                                <div class="col-sm-12 mb-4">
                                    <select class="form-select form-select-lg" id="pilih_mapel" aria-label="Default select options">
                                        ...
                                        @foreach ($response->kelas as $output)
                                            <option value="{{ $output->id }}">{{ $output->nama_kelas }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            <div class="form-group d-flex align-items-center justify-content-between mt-4 mb-7">
                                ...
                                <button class="btn btn-primary" type="button" onclick="buat()">Absen</button>
                            </div>
                        </form>

                        <h2 class="mb-4 mt-5">Data Absen Guru</h2>
        ...
        <script>
            ...
            function buat() {
                const pilihMapel = document.getElementById('pilih_mapel').value;

                if (pilihMapel === '') {
                    alert('Silahkan Pilih Ruang Kerja, Ruang Kerja Tidak Boleh Kosong');
                } else {
                    const data = {
                        id_k: pilihMapel,
                        id_g: localStorage.getItem('id')
                    };

                    fetch('{{ $url }}/api/absen', {method: 'POST',body: JSON.stringify(data),headers: {'Content-Type': 'application/json'}})
