...
<html lang="en">
    <head>
        ...
        <title>Admin Sekolah - Admin</title>
        <!-- Load Favicon-->
                ...
                <nav class="drawer accordion drawer-light bg-white" id="drawerAccordion">
                    <div class="drawer-menu">
                        <div class="nav">
                            ...
                            <a class="nav-link active" href="admin_sekolah">
            ...
            <div id="layoutDrawer_content">
                ...
                <main>
                    <div class="container-xl px-5">
                        ...
                        <h2 class="mb-4 mt-5">Tambah Data Admin</h2>
                        
                        <form>
                            <div class="row">
                                <div class="col-sm-12 mb-4"><mwc-textfield class="w-100" id="nama_lengkap" label="Nama Lengkap" outlined=""></mwc-textfield></div>
                            </div>
                            <div class="row">
                        ...
                        <h2 class="mb-4 mt-5">Ubah Data Admin</h2>
                        
                        <form>
                            <input type="hidden" id="id">
                            <div class="row">
                                <div class="col-sm-12 mb-4"><mwc-textfield class="w-100" id="nama_lengkap_update" label="Nama Lengkap" outlined=""></mwc-textfield></div>
                            </div>
                            <div class="row">
                        ...
                        <h2 class="mb-4 mt-5">Data User Admin Sekolah</h2>
                        ...
                        <table id="datatablesSimple">
                            ...
                            <tbody>
                                ...
                                @foreach ($response->admin as $output)
                                    <tr>
                                        <td>{{ $position++ }}</td>
                                        <td>{{ $output->nama_admin }}</td>
                                        <td>{{ $output->username_admin }}</td>
                                        <td>
                                            <button type="button" class="btn btn-danger" onclick="hapus({{ $output->id }})">HAPUS</button>
                                            <button type="button" class="btn btn-primary" onclick="berubah('{{ $output->id }}', '{{ $output->nama_admin }}', '{{ $output->username_admin }}', '{{ $output->password_admin }}')">UBAH</button>
                                        </td>
                                    </tr>
                                @endforeach
                            </tbody>
        ...
        <script>
            ...
            function ubah() {
                ...
                if (id === '') {
                    ...
                    fetch('{{ $url }}/api/admin_update', {method: 'POST',body: JSON.stringify(data),headers: {'Content-Type': 'application/json'}})
                    .then(response => response.json())
                    .then(data => {
                        alert(data.catatan);
                        location.reload(data.aksi);
            ...
            function hapus(id) {
                fetch('{{ $url }}/api/admin/' + id, {method: 'DELETE',headers: {'Content-Type': 'application/json'}})
                    .then(response => response.json())
                    .then(data => {
                        alert(data.catatan);
                        location.reload(data.aksi);
